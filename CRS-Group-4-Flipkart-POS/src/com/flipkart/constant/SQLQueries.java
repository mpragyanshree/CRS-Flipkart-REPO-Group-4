...
public class SQLQueries {
    ...
    public static final String MAKE_PAYMENT = "INSERT INTO payments(studentId, amount, paymenttime, paymentstatus, paymentmode, paymentid, notificationsent, notificationid) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public static final String UPDATE_PROFESSOR1 = "update professor set department=?,designation=? where userid=?";
    ...
    // generate gradecard
    public static final String GENERATE_GRADE_CARD = "update deadline set gradecardgenerated = ?";
    // view available courses
    public static final String ADMIN_VIEW_AVAILABLE_COURSES = "select coursecode, coursename, instructorid, numnberofseats where numberofseats >= 3";
    ...
    public static final String ADMIN_REMOVE_PROFESSOR = "DELETE FROM professor WHERE professorid=?";
    ...
    public static final String GET_MAX_USER_ID = "SELECT MAX(userid) FROM user";
    ...
    public static final String CHANGE_PAYMENT_WINDOW_STATUS = "UPDATE deadline SET paymentwindow= ? WHERE semester_id = ?";
    // Student Queries
    ...
    public static final String CHECK_GRADECARD = "select gradecardgenerated FROM deadline where semesterID = ?";
    //-----------
    ...
    public static final String REGISTRATION_GET_COURSES = "SELECT * FROM coursecatalog WHERE courseid = ?";
    public static final String REGISTRATION_DROP_COURSE = "DELETE FROM registeredcourses WHERE studentid = ? AND coursecode = ?";
    public static final String REGISTRATION_COURSE_EXISTS = "SELECT COUNT(1) FROM registeredcourses WHERE studentid = ? AND courseid = ? ";
    public static final String REGISTRATION_UPDATE_SEATS = "UPDATE coursecatalog SET numberofseats = ? WHERE  courseid = ? ";
    ...
    public static final String REGISTRATION_ADD_COURSE = "INSERT INTO registeredcourses VALUES (?,?,?,?,?,?,?)";
